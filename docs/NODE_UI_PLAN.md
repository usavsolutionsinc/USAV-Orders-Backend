...
> **Companions:** `docs/NODE_WORKFLOW_ARCHITECTURE.md` (why/what), `docs/NODE_WORKFLOW_IMPLEMENTATION_PLAN.md` (full phasing), `docs/NODE_UI_PLAN.md` (this — the UI that's deferred).
