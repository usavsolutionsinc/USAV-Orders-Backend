        ...
        <li className="flex items-start gap-3 border-b border-gray-100 px-4 py-2.5 hover:bg-blue-50/40 sm:px-6">
            ...
            >
                <div className="flex flex-wrap items-baseline gap-x-2 gap-y-0.5">
                    ...
                    <span className={`rounded px-1.5 py-0.5 text-[10px] font-medium uppercase tracking-wide ${statusTone}`}>
                        {row.current_status}
                    </span>
                    {row.condition_grade ? (
            ...
            <div className="flex shrink-0 flex-col items-end gap-0.5 text-[11px] text-gray-500">
                {skuHref ? (
                    <Link
                        href={skuHref}
