...
export function PinThisPageButton({ onPinned }: PinThisPageButtonProps) {
  ...
  return (
    <button
      type="button"
      onClick={handleClick}
      className="inline-flex items-center gap-1 rounded-md px-2 py-1 text-[10px] font-bold uppercase tracking-widest text-blue-600 hover:bg-blue-50"
    >
...
export default PinThisPageButton;
