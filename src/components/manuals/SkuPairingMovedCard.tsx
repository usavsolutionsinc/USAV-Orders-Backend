...
export function SkuPairingMovedCard() {
  return (
    <div className="flex h-full flex-col items-center justify-center bg-white px-6 py-12 text-center">
      ...
      <h2 className="mt-3 text-sm font-black uppercase tracking-tight text-gray-900">
        Pairing moved
      </h2>
      <p className="mt-1 max-w-xs text-caption font-semibold leading-snug text-gray-500">
      ...
      <Link
        ...
        className="mt-4 inline-flex items-center gap-1.5 rounded-full bg-gray-900 px-4 py-1.5 text-micro font-black uppercase tracking-[0.14em] text-white transition-colors hover:bg-gray-800"
      >
