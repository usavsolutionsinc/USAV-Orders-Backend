      ...
      <div className="border-b border-gray-200 bg-white px-6 py-4">
        ...
        <div className="mt-2 flex flex-wrap gap-1.5">
          {detail.packer_logs.map((pl) => (
            <span
              key={pl.id}
              className="inline-flex items-center gap-1 rounded-full bg-emerald-50 px-2 py-0.5 text-[10px] font-semibold text-emerald-700 ring-1 ring-emerald-200"
            >
      ...
      {photoUrl && (
        <div className="mt-2 flex items-center gap-2">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="break-all text-[11px] font-semibold text-violet-700 hover:underline"
          >
            View photo
          </a>
        </div>
