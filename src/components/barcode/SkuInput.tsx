    ...
    return (
        <div className={`transition-opacity duration-200 ${!isActive ? 'opacity-25 pointer-events-none' : ''}`}>
            <div className="flex items-center gap-3 px-5 pt-5 pb-3">
                ...
                <span className="text-[9px] font-black uppercase tracking-[0.18em] text-gray-600">SKU</span>
            </div>
            ...
            <div className="flex border-t border-b border-gray-200">
                <input
                    ...
                    className="flex-1 px-4 py-4 bg-white text-sm focus:outline-none font-mono placeholder:text-gray-500 text-gray-900"
                ...
                <button
                    ...
                    className="px-4 bg-white text-gray-500 hover:text-gray-800 hover:bg-gray-50 transition-colors border-l border-gray-200 flex items-center justify-center"
                >
                ...
                <button
                    onClick={onNext}
                    title="Search"
                    className="px-5 bg-blue-600 text-white hover:bg-blue-700 transition-colors flex items-center justify-center border-l border-blue-600"
                >
