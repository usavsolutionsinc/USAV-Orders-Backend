    ...
    <div className="space-y-5">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-eyebrow font-bold text-gray-500 uppercase tracking-wide mt-0.5">
      ...
      {/* ESIGN/UETA Consent */}
      <p className="text-micro text-gray-500 italic leading-relaxed bg-gray-50 p-3 border border-gray-200">
...
function DetailRow({ label, value, highlight, isLast }: { label: string; value: string; highlight?: boolean; isLast?: boolean }) {
  return (
    <div className={`flex items-stretch ${!isLast ? 'border-b border-gray-200' : ''}`}>
      <span className="text-eyebrow font-black uppercase tracking-wide text-gray-500 bg-gray-50 px-3 py-2.5 w-20 shrink-0 flex items-center border-r border-gray-200">
        {label}
      </span>
