  ...
  return (
    <section className="space-y-3">
      <div className="flex items-center justify-between gap-2">
        <h3 className="text-caption font-black uppercase tracking-[0.16em] text-gray-900">
          {title}
        ...
        <div className="ml-auto flex shrink-0 items-center gap-1.5">
          <HoverTooltip label="Add favorite" asChild>
            <IconButton
              ...
              className="flex h-8 w-8 items-center justify-center rounded-lg border border-gray-200 bg-white text-gray-600 hover:border-gray-900 hover:text-gray-900"
        ...
        <>
          {f.isLoading ? (
            ...
            <div className="rounded-xl border border-dashed border-gray-200 px-4 py-8 text-center">
              <p className="text-micro font-black uppercase tracking-[0.14em] text-gray-400">{emptyLabel}</p>
            </div>
          ) : (
                  ...
                  <div key={`${favorite.workspaceKey}-${favorite.id}`} className="flex min-h-[132px] flex-col overflow-hidden rounded-xl border-2 border-gray-200 bg-white">
                    <div className="flex flex-1 flex-col p-4 pb-3">
                      ...
                      <div className="mt-2 flex min-w-0 items-baseline gap-2">
                        ...
                        {favorite.sku && <span className="min-w-0 truncate text-micro font-bold uppercase tracking-[0.12em] text-gray-400">{favorite.sku}</span>}
                      </div>
                    ...
                    <div className="border-t border-gray-100 p-2">
                      <Button
                        ...
                        className="w-full text-micro font-black uppercase tracking-[0.14em] text-gray-900"
                      >
                        {useLabel}
                      </Button>
                    </div>
