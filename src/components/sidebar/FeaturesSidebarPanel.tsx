      ...
      <div className="flex-1 overflow-y-auto">
        ...
        >
          <div>
            ...
            <p className={`mt-0.5 ${fieldLabel} text-gray-500`}>Create a feature or bug fix entry</p>
          </div>
        ...
        >
          <div>
            ...
            <p className={`mt-0.5 ${fieldLabel} text-gray-500`}>Reset search and feature views</p>
          </div>
          <span className="inline-flex h-10 w-12 items-center justify-center border-l border-gray-200 text-gray-600">
