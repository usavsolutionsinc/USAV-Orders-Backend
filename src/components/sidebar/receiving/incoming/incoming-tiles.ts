...
> = {
  rose: { active: 'bg-rose-600 text-white ring-rose-600', inactive: 'bg-white text-rose-700 ring-rose-200 hover:bg-rose-50', ring: 'focus:ring-rose-500/40', iconActive: 'text-white', iconInactive: 'text-rose-500', pill: 'bg-rose-50 text-rose-700 ring-rose-200 hover:bg-rose-100' },
  amber: { active: 'bg-amber-600 text-white ring-amber-600', inactive: 'bg-white text-amber-800 ring-amber-200 hover:bg-amber-50', ring: 'focus:ring-amber-500/40', iconActive: 'text-white', iconInactive: 'text-amber-500', pill: 'bg-amber-50 text-amber-800 ring-amber-200 hover:bg-amber-100' },
  orange: { active: 'bg-orange-600 text-white ring-orange-600', inactive: 'bg-white text-orange-800 ring-orange-200 hover:bg-orange-50', ring: 'focus:ring-orange-500/40', iconActive: 'text-white', iconInactive: 'text-orange-500', pill: 'bg-orange-50 text-orange-800 ring-orange-200 hover:bg-orange-100' },
  blue: { active: 'bg-blue-600 text-white ring-blue-600', inactive: 'bg-white text-blue-700 ring-blue-200 hover:bg-blue-50', ring: 'focus:ring-blue-500/40', iconActive: 'text-white', iconInactive: 'text-blue-500', pill: 'bg-blue-50 text-blue-700 ring-blue-200 hover:bg-blue-100' },
  gray: { active: 'bg-gray-700 text-white ring-gray-700', inactive: 'bg-white text-gray-700 ring-gray-200 hover:bg-gray-50', ring: 'focus:ring-gray-500/40', iconActive: 'text-white', iconInactive: 'text-gray-500', pill: 'bg-gray-50 text-gray-700 ring-gray-200 hover:bg-gray-100' },
  slate: { active: 'bg-slate-900 text-white ring-slate-900', inactive: 'bg-white text-slate-700 ring-slate-200 hover:bg-slate-50', ring: 'focus:ring-slate-500/40', iconActive: 'text-white', iconInactive: 'text-slate-500', pill: 'bg-slate-50 text-slate-700 ring-slate-200 hover:bg-slate-100' },
  violet: { active: 'bg-violet-600 text-white ring-violet-600', inactive: 'bg-white text-violet-700 ring-violet-200 hover:bg-violet-50', ring: 'focus:ring-violet-500/40', iconActive: 'text-white', iconInactive: 'text-violet-500', pill: 'bg-violet-50 text-violet-700 ring-violet-200 hover:bg-violet-100' },
  red: { active: 'bg-red-600 text-white ring-red-600', inactive: 'bg-white text-red-700 ring-red-200 hover:bg-red-50', ring: 'focus:ring-red-500/40', iconActive: 'text-white', iconInactive: 'text-red-500', pill: 'bg-red-50 text-red-700 ring-red-200 hover:bg-red-100' },
};
