...
export function OutOfStockField({
  ...
  return (
    <div className={className}>
      <span className="text-[10px] text-red-700 font-black uppercase tracking-widest block mb-1.5">Out Of Stock</span>
      <div className="space-y-2 rounded-xl border border-red-200 bg-red-50/40 p-3">
        {editable ? (
          ...
          <p
            className={`rounded-lg border border-red-200 bg-white px-3 py-2 text-sm font-normal text-gray-900 leading-5 break-words whitespace-pre-wrap ${dmSans.className}`}
            style={{
              display: '-webkit-box',
              WebkitLineClamp: 2,
