...
export function StaffEditCard({
  ...
  return (
    <div key={member.id} className="border-b border-border-hairline px-3 py-4">
      {/* Card shell: rounded, soft shadow, left accent border in the live
          ...
          corners. */}
      <div
        className="rounded-3xl bg-gradient-to-br from-white via-white to-gray-50 px-6 py-5 shadow-md shadow-gray-200/40 ring-1 ring-border-soft"
      ...
      >
        ...
        <label className="mt-5 inline-flex cursor-pointer items-center gap-2.5 rounded-full bg-surface-card px-3.5 py-2 text-caption font-semibold uppercase tracking-[0.16em] text-text-muted ring-1 ring-border-soft transition hover:bg-surface-hover">
          <input
            ...
            className="h-4 w-4 rounded-full border-border-default text-text-default"
          />
          Active staff record
        </label>
