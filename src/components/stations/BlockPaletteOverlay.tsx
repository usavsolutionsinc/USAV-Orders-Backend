                ...
                <div className="space-y-1.5">
                  {blocks.map((b) => (
                    <button
                      ...
                      className="flex w-full items-start gap-2.5 rounded-lg border border-gray-200 bg-white px-2.5 py-2 text-left transition-colors hover:border-blue-300 hover:bg-blue-50/40"
                    >
