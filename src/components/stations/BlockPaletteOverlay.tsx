                ...
                <div className="space-y-1.5">
                  {blocks.map((b) => (
                    <button
                      ...
                      className="ds-raw-button flex w-full items-start gap-2.5 rounded-lg border border-border-soft bg-surface-card px-2.5 py-2 text-left transition-colors hover:border-blue-300 hover:bg-blue-50/40"
                    >
                      <span className="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-md bg-surface-sunken text-text-muted">
