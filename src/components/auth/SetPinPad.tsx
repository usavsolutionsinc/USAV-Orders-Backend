...
const THEME_NUMPAD: Record<StationTheme, {
  ...
  black:     { primaryBg: 'bg-slate-900',    primaryHover: 'hover:bg-slate-800',   dotActive: 'bg-slate-900',    accentText: 'text-text-default',    haloFrom: 'from-slate-300/60',    passkeyHover: 'hover:bg-surface-sunken',   ring: 'focus:ring-slate-500/30' },
