    ...
    <div className="rounded-2xl border border-blue-100 bg-blue-50/70 px-4 py-3">
      <div className="space-y-2">
        <button
          ...
          className={`inline-flex w-full items-center justify-center gap-1 rounded-xl border border-blue-200 bg-white px-3 py-2 ${sectionLabel} text-blue-700 transition-colors hover:bg-blue-100 disabled:cursor-not-allowed disabled:border-blue-100 disabled:bg-blue-50 disabled:text-blue-300`}
        >
