export const sidebarHeaderBandClass = 'shrink-0 border-b border-gray-100 bg-white';
export const sidebarHeaderRowClass = 'flex min-h-[44px] items-center px-3 py-1';
export const sidebarHeaderControlClass = 'h-full min-h-[44px] w-full appearance-none bg-white px-3 py-1 pr-8 text-left text-[10px] font-black uppercase tracking-wider text-gray-700 outline-none transition-colors hover:bg-gray-50';
