  ...
  return (
    <div className="relative hidden shrink-0 sm:block">
      <button
        ...
        title="Your top work order"
        className={cn(
          'flex max-w-[220px] items-center gap-1.5 rounded-full border border-indigo-200 bg-indigo-50/70 py-0.5 pl-2 pr-1.5 transition-colors hover:bg-indigo-100/70',
          open && 'bg-indigo-100',
        )}
      >
        <ClipboardList className="h-3.5 w-3.5 shrink-0 text-indigo-600" />
        <span className="min-w-0 truncate text-[11px] font-bold tracking-tight text-indigo-900">
          {top.title}
        </span>
        <ChevronDown
      ...
      >
        <div className="border-b border-gray-100 px-3.5 py-3">
          ...
          {top.subtitle ? (
            <p className="mt-0.5 truncate text-[11px] text-gray-500">{top.subtitle}</p>
          ) : null}
        </div>
        <div className="flex flex-wrap items-center gap-1.5 px-3.5 py-2.5">
          <span className="rounded-full bg-gray-100 px-2 py-0.5 text-[9px] font-black uppercase tracking-wider text-gray-600">
            {top.queueLabel}
          </span>
          <span className="rounded-full bg-indigo-50 px-2 py-0.5 text-[9px] font-black uppercase tracking-wider text-indigo-600">
            {top.role}
          </span>
          {deadlineLabel ? (
        ...
        <div className="border-t border-gray-100 px-3.5 py-2.5">
          <Link
            ...
            className="inline-flex w-full items-center justify-center rounded-lg bg-indigo-600 px-3 py-2 text-[12px] font-bold text-white transition-colors hover:bg-indigo-700"
          >
