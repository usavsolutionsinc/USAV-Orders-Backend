...
export function OfflineBanner() {
  ...
  return (
    <div
      role="status"
      aria-live="polite"
      className={`fixed inset-x-0 top-0 z-banner px-3 pb-1.5 pt-[max(0.375rem,env(safe-area-inset-top,0px))] text-center text-caption font-black uppercase tracking-widest ${tone}`}
    >
      {message}
    </div>
  );
