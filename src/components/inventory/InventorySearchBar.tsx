...
export function InventorySearchBar({ initial, onSubmit }: InventorySearchBarProps) {
    ...
    return (
        <form onSubmit={handleSubmit} className="relative w-full">
            ...
            <div className="absolute right-2 top-1/2 flex -translate-y-1/2 items-center gap-1">
                ...
                <kbd className="hidden rounded border border-gray-200 bg-gray-50 px-1.5 py-0.5 font-mono text-micro text-gray-500 sm:inline-block">
                    /
                </kbd>
            </div>
        </form>
