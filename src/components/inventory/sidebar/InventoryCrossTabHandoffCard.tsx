                ...
                {candidates.map(({ tab, count, capped }) => {
                    ...
                    return (
                        <button
                            ...
                            type="button"
                            onClick={() => onJump(tab)}
                            className="ds-raw-button flex items-center justify-between gap-2 rounded-lg border border-blue-200 bg-surface-card px-2.5 py-2 text-left transition-colors hover:border-blue-400 hover:bg-blue-100"
                        >
