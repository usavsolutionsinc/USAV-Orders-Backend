...
/**
 * Unified filter component for the inventory sidebar. Consolidates:
 *   - Search field selection (ALL / SKU / BIN / USER / …)
 *   - Status bucket filters (multi-select)
 *
 * This keeps the sidebar header clean by moving secondary controls into
 * a single popover.
 */
