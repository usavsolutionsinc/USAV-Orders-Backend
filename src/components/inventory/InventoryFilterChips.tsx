        ...
        <div className="flex flex-wrap items-start gap-2">
                    ...
                    {SERIAL_STATUS_VALUES.map((s) => {
                        ...
                        return (
                            <button
                                ...
                                className={`rounded-full px-2 py-1 text-caption font-medium ring-1 ring-inset transition-opacity ${tone} ${selected ? '' : 'opacity-50 hover:opacity-100'}`}
                            >
                                {s}
                            </button>
                        );
            ...
            {totalSelected > 0 ? (
                <button
                    type="button"
                    onClick={onClear}
                    className="inline-flex items-center gap-1 rounded-full border border-gray-200 px-2.5 py-1 text-caption text-gray-500 hover:bg-gray-50 hover:text-gray-900"
                >
                    Clear
                    <X className="h-3 w-3" />
                </button>
    ...
    return (
        <div className="relative">
            ...
            >
                {label}
                {count > 0 ? (
                    <span className="rounded-full bg-blue-600 px-1.5 py-0.5 text-micro font-semibold text-white">
                        {count}
                    </span>
                ) : null}
                <svg
