  ...
  return (
    <>
      <button
        ...
        title="Scan"
        className="fixed bottom-[max(1.25rem,env(safe-area-inset-bottom))] right-5 z-[95] flex h-16 w-16 items-center justify-center rounded-full shadow-[0_8px_24px_rgba(17,24,39,0.35)] transition-transform active:scale-95 bg-blue-600 text-white active:bg-blue-700"
      >
