        ...
        {isExpanded ? (
          ...
          >
            <button
              type="button"
              onClick={openSearch}
              className="ds-raw-button flex-shrink-0 inline-flex h-8 w-8 items-center justify-center rounded-full border border-border-soft text-text-faint hover:border-border-default hover:text-text-muted transition-colors"
