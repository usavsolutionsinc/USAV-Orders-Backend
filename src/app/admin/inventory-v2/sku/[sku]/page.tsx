...
/**
 * /admin/inventory-v2/sku/[sku] — Per-SKU operations view.
 *
 * Read-only. Sections:
                ...
                {recentUnits.map((u) => (
                  <tr key={u.id}>
                    <td className="px-6 py-2 font-mono text-xs">
                      <Link href={`/admin/inventory-v2/units/${u.id}`} className="text-blue-600 hover:underline">
                        {u.serial_number}
                      </Link>
                    </td>
              ...
              <tbody className="divide-y divide-gray-100">
                {allocations.map((a) => (
                  <tr key={a.id}>
                    ...
                    <td className="px-6 py-2 font-mono text-xs">
                      <Link href={`/admin/inventory-v2/units/${a.serial_unit_id}`} className="text-blue-600 hover:underline">
                        #{a.serial_unit_id}
                      </Link>
                    </td>
