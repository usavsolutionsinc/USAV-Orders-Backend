...
/**
 * /admin/inventory-v2/events — Global inventory_events explorer.
 *
...
function buildPageHref(
  ...
  return qs ? `/admin/inventory-v2/events?${qs}` : '/admin/inventory-v2/events';
}
    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="mx-auto max-w-7xl space-y-6">
        <header className="space-y-1">
          ...
          <h1 className="text-2xl font-semibold text-gray-900">Inventory events</h1>
          <p className="text-sm text-gray-600">
            Global event log. Filters compose; the URL is shareable.
          </p>
        </header>

        <form action="/admin/inventory-v2/events" method="get" className="grid grid-cols-2 gap-3 rounded-lg border border-gray-200 bg-white p-4 shadow-sm md:grid-cols-4">
          <div>
          ...
          <div className="flex items-end gap-2">
            ...
            <Link href="/admin/inventory-v2/events" className="rounded-md border border-gray-300 bg-white px-4 py-1.5 text-sm font-medium text-gray-700 hover:bg-gray-50">
              Clear
            </Link>
          </div>
        </form>
