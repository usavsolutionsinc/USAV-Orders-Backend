        ...
        <>
                    ...
                    >
                        <div className="absolute top-4 right-4 z-50">
                            <button
                                ...
                                className="p-2 bg-gray-50 hover:bg-gray-100 text-gray-400 hover:text-gray-600 rounded-xl transition-all border border-gray-100"
                                title="Hide Sidebar"
                            >
            ...
            {!isOpen && (
                <button
                    ...
                    className="fixed top-24 left-0 z-50 p-3 bg-white text-gray-900 rounded-r-2xl shadow-2xl hover:bg-orange-600 hover:text-white transition-all duration-300 group border border-l-0 border-gray-200"
                    title="Open Repair Sidebar"
                >
                    <div className="flex flex-col items-center gap-2">
                        <ChevronRight className="w-5 h-5 group-hover:translate-x-0.5 transition-transform" />
                        <span className="[writing-mode:vertical-lr] text-[9px] font-black uppercase tracking-widest py-2">Repairs</span>
                    </div>
                </button>
            )}
