...
/** Re-edit: push an FBA Shipment ID into the paired review panel for reassignment. detail: { amazonShipmentId: string } */
export const FBA_REEDIT_SHIPMENT = 'fba-reedit-shipment' as const;
...
/** Refresh active shipments panel without a full data reload */
export const FBA_ACTIVE_SHIPMENTS_REFRESH = 'fba-active-shipments-refresh' as const;
/** Station FNSKU scan result (detail: { fnsku, productTitle, shipmentId, planRef }) */
export const FBA_FNSKU_STATION_SCANNED = 'fba-fnsku-station-scanned' as const;
